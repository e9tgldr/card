...
export const STRINGS = {
  ...
  'admin.arPack.targetOrder': { mn: 'Картуудын дараалал',                    en: 'Target order' },
  'admin.arPack.targetOrder.hint':       { mn: 'Дараалал нь .mind файлд хийсэн зургуудын дараалалтай тохирно. Чирж дараалуулна.', en: 'The order must match the order of images in the compiled .mind file. Drag to reorder.' },
  'admin.arPack.targetOrder.add':        { mn: '+ Зүтгэлтэн нэмэх',                  en: '+ Add target' },
  'admin.arPack.targetOrder.remove':     { mn: 'Хасах',                              en: 'Remove' },
  'admin.arPack.targetOrder.empty':      { mn: 'Хоосон байна. Дор хаяж 1 зүтгэлтэн нэмнэ үү.', en: 'Empty. Add at least one figure.' },
  'admin.arPack.targetOrder.duplicate':  { mn: 'Энэ зүтгэлтэн аль хэдийн бүртгэлтэй', en: 'This figure is already in the list' },
  'admin.arPack.targetOrder.unknown':    { mn: 'Тодорхойгүй',                        en: 'Unknown' },
  'admin.arPack.targetOrder.save':       { mn: 'Дараалал хадгалах',                  en: 'Save order' },
  'admin.arPack.targetOrder.saved':      { mn: 'Хадгалагдлаа',                       en: 'Saved' },
